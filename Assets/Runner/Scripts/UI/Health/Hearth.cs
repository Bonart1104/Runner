...
public class Hearth : MonoBehaviour
{
    ...
    private IEnumerator Filling (float starValue,float endValue, float duration, UnityAction <float> lerpingEnd)
    {
        float elapsed = 0;
        float nextValue;
        ...
        {
            nextValue = Mathf.Lerp(starValue, endValue, elapsed/duration);
